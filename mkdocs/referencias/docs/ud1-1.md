...
- **Actividad**: Debéis crear moodboard con imágenes búsquedas en Internet (personajes, paisajes, colores, texturas). El moodboard debe representar la atmósfera, temática o estilo artístico de un videojuego que quieran desarrollar.
- **Duración**: 1 hora.
