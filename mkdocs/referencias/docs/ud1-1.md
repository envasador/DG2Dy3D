...
- **Actividad**: Pide a los alumnos que creen un moodboard con imágenes recortadas de revistas o búsquedas en Internet (personajes, paisajes, colores, texturas). El moodboard debe representar la atmósfera, temática o estilo artístico de un videojuego que quieran desarrollar.
- **Duración**: 1 hora.
- **Materiales**: Revistas, tijeras, pegamento, acceso a internet (o herramientas digitales como Pinterest).
