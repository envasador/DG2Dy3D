...
## **2.1 Las etapas del proceso creativo**

Crear arte conceptual para videojuegos no es cuestión de sentarse y esperar la inspiración. Es un proceso estructurado que te lleva desde una idea difusa hasta diseños concretos listos para producción. Veamos cómo funciona:
...
### **2. Investigación, referencias y moodboard: construye tu visión**
...
Mientras investigas, vas construyendo tu **moodboard**: ese collage visual que reúne todas esas referencias en un solo lugar. Imágenes, colores, texturas, cualquier elemento que capture la esencia de tu proyecto. Es tu álbum de recortes donde juntas todo lo que te inspira y define visualmente la atmósfera que buscas.

¿El objetivo? No se trata de copiar, sino de ampliar tu vocabulario visual. Cuantas más referencias de calidad tengas, más herramientas tendrás para crear algo único. Y el moodboard será tu brújula visual constante durante todo el proceso.

Como vimos en la sección anterior, puedes usar herramientas como Pinterest, PureRef, Milanote o simplemente Photoshop para organizar todo este material.
...
Este es un proceso iterativo: dibujas, recibes comentarios, ajustas, vuelves a dibujar. Poco a poco, esas ideas vagas se convierten en conceptos sólidos que empiezan a tener personalidad propia.
...
## **2.2 Técnicas y elementos del proceso creativo**
...
## **2.3 Perspectiva de género en el proceso creativo**
...
## **2.4 Estilos artísticos en videojuegos**
...
Aquí tienes una guía completa de los estilos más comunes en la industria:

---

### **Realismo / fotorrealismo: imitando la realidad**
...
**Ejemplos**: *The Last of Us Part II*, *Red Dead Redemption 2*, *Microsoft Flight Simulator*

**Consideraciones**: Requiere mucho tiempo y recursos. Envejece peor que otros estilos. Necesita hardware potente.

---

### **Estilizado / stylized: realidad con personalidad**
...
**Ejemplos**: *Overwatch*, *Fortnite*, *Valorant*, *Apex Legends*

**Consejo**: Este estilo envejece mejor que el realismo puro y permite mayor expresividad artística.

---

### **Cartoon / caricaturesco: exageración expresiva**
...
**Ejemplos**: *Crash Bandicoot*, *Ratchet & Clank*, *Spyro*, *Psychonauts*

**Consideraciones**: No significa que sea "para niños". Puede abordar temas complejos con estética amigable.

---

### **Cel shading / toon shading: 3D que parece 2D**
...
**Ejemplos**: *The Legend of Zelda: Wind Waker*, *Jet Set Radio*, *Borderlands*, *Persona 5*

**Ventajas**: Estilo atemporal que no envejece, distintivo visual fuerte

---

### **Pixel art: nostalgia funcional**
...
**Ejemplos**: *Celeste*, *Stardew Valley*, *Hyper Light Drifter*, *Dead Cells*

**Consideraciones**: No es "fácil" por ser retro. Pixel art de calidad requiere mucha habilidad y tiempo.

---

### **Low poly: minimalismo geométrico**
...
**Ejemplos**: *Firewatch*, *Monument Valley*, *Superhot*, *Journey*

**Ventajas**: Rendimiento excelente, estética distintiva, funciona bien en cualquier hardware

---

### **Hand-painted / pintado a mano: calidez artesanal**
...
**Ejemplos**: *Thomas Was Alone*, *Mini Metro*, *Letterpress*, *140*

**Ventajas**: Claridad absoluta, enfoque en mecánicas, accesibilidad visual
...
**Consideraciones**: Permite modificación del mundo de forma natural

---

### **Noir / monocromático: drama en blanco y negro**
...
**Ejemplos**: *Limbo*, *Inside*, *Gris* (monocromático de colores), *Othercide*

**Ventajas**: Enfoque en forma, composición y narrativa. Muy distintivo.
...
**Ejemplos**: *Bloodborne*, *Dark Souls*, *Castlevania*, *Diablo*

**Consideraciones**: Balance crucial entre oscuridad y legibilidad

---

### **Cyberpunk: neón y distopía**
...
**Ejemplos**: *Cyberpunk 2077*, *Ghostrunner*, *Observer*, *Dex*

**Consideraciones**: Muy popular actualmente. Necesitas identidad propia para destacar.

---

### **Steampunk: vapor y engranajes**
...
**Ejemplos**: *Bioshock Infinite*, *Dishonored*, *Arcanum*, *Frostpunk* (con toques)

**Consideraciones**: Requiere investigación de era victoriana y mecánica

---

### **Surrealismo: lógica de sueños**
...
**Ejemplos**: *Antichamber*, *Superliminal*, *Manifold Garden*, *Psychonauts*

**Consideraciones**: Debe mantener legibilidad pese a la extrañeza

---

### **Horror: inquietud visual**
...
**Ejemplos**: *Silent Hill*, *Resident Evil*, *Amnesia*, *Outlast*

**Consideraciones**: Balance entre aterrador y jugable. No tanto que resulte injusto.
...
**Consideraciones**: Puede resultar perturbador; perfecto para ese propósito
